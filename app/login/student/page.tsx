...
import { GraduationCap, Facebook, Github, ChromeIcon as Google } from "lucide-react"
        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" asChild>
              <Link href="/login/university">Sou Universidade</Link>
            </Button>
          </div>
        </div>
      </header>
        ...
        <div className="flex flex-col lg:flex-row w-full max-w-5xl gap-8 items-center">
          <div className="flex-1 space-y-4 text-center lg:text-left">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Bem-vindo, Universitário!</h1>
              <p className="text-muted-foreground md:text-xl">
                Acesse sua conta para encontrar as melhores oportunidades acadêmicas e profissionais.
              </p>
            </div>
          ...
          <div className="w-full max-w-md">
            <Card className="border-2">
              <CardHeader className="space-y-1">
                <CardTitle className="text-2xl text-center">Login do Universitário</CardTitle>
